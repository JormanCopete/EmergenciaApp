using AppEmergencia.Controls;
using AppEmergencia.ViewModels.Security;
using System;
    ...
    public class ErrorValidationColorConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            if (PageVariantParameter == "0")
            {
                ...
                bindingContext.IsInvalidNuip = !isFocused && !CheckValidNuip(bindingContext.Nuip);
                ...
                return bindingContext.IsInvalidNuip ? Color.FromHex("#FF4A4A") : Color.Transparent;
            ...
            else
            {
                ...
                bindingContext.IsInvalidNuip = !isFocused1 && !CheckValidNuip(bindingContext.Nuip);
                ...
                return bindingContext.IsInvalidNuip ? Color.FromHex("#FF4A4A") : Color.FromHex("#ced2d9");
        ...
        private static bool CheckValidNuip(string nuip)
        {
            if (string.IsNullOrEmpty(nuip))
            {
                return true;
            }

            var regex = new Regex(@"^\d+$");
            return regex.IsMatch(nuip);            
        }
    }
